...
function prodKeySearch(searchKey) {
    $.ajax({
        type : "get",
        url : getRootPath() + "/data/search/searchProdList",
        dataType : 'json',
        data : {
            name : searchKey
        },
...
function initProdHTML(productList) {
    ...
    for (var i = 0; i < productList.length; i++) {
        ...
        productListString += "<div class='col-md-2' style='height:280px; width: 250px; text-align: center'>\n" +
            "            <a href=/second_hand_market/view/search/searchProduct?productNumber=" + productList[i].productNumber + ">\n" +
            "                <img src=/second_hand_market/image/" + productList[i].image + " width='170px' height='170px' align='center' style='display: inline-block;'>\n" +
            "            </a>\n" +
            "            <p>\n" +
            "                <a href=/second_hand_market/view/search/searchProduct?productNumber=" + productList[i].productNumber + " style=''>" + productList[i].name + "</a>\n" +
            "            </p>\n" +
...
function prodNumberSearch(productNumber) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchProductInfo",
        dataType : "json",
        data : {
        ...
        success : function (result) {
            if (result.code == 0) {
                ...
                document.getElementById("prodImg").src = "/second_hand_market/image/" + productInfo.productDo.image;
...
function prodListConditionSearch() {
    ...
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchProdListByQo",
        dataType : 'json',
        data : {
            typeCode : typeCode,
...
function demandInfoKeySearch(searchKey) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchDemandInfoList",
        dataType : 'json',
        data : {
            name : searchKey
        },
...
function initDemandInfoHTML(demandInfoList) {
    ...
    for (var i = 0; i < demandInfoList.length; i++) {
        demandInfoString += "<tr><td style='text-align: center'>"+ demandInfoList[i].demandInfoNumber +"</td>" +
            "<td style='text-align: center'><a href='/second_hand_market/view/search/searchDemandInfo?demdInfoNumber=" + demandInfoList[i].demandInfoNumber +"'>" + demandInfoList[i].name + "</a></td>" +
...
function DemdInfoListCondSearch() {
    ...
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchDemdInfoListByQo",
        dataType : 'json',
        data : {
            typeCode : typeCode,
            depRateSymbol : depRateSymbol,
...
function demdInfoNumberSearch(demdInfoNumber) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchDemandInfo",
        dataType : "json",
        data : {
...
function buyBOUTProd() {
    ...
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/order/generateOrder",
        dataType : "json",
        data : {
            productNumber : productNumber,
        },
        success : function (result) {
            if (result.code == 105) {
                alert(result.message);
                window.location.href = "/second_hand_market/";
            } else {
                alert(result.message);
            }
        },
...
function buyBIDDProd() {
    ...
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/price/BIDD",
        dataType : "json",
        data : {
            productNumber : productNumber,
...
function buyBARGProd() {
    ...
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/price/BARG",
        dataType : "json",
        data : {
            productNumber : productNumber,
...
function loadMyOrder() {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/order/myOrderList",
        dataType : "json",
        success : function (result) {
            if (result.code == 0) {
...
function checkBuyPriceRecord(prodId) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/order/searchBuyPriceRecord",
        dataType : "json",
        data : {
            productId : prodId
        },
...
function checkSalePriceRecord(prodId) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/order/searchSalePriceRecord",
        dataType : "json",
        data : {
            productId : prodId
        },
...
function loadMyProducts() {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/searchMyProduct",
        dataType : "json",
        success : function (result) {
            if (result.code == 0) {
...
function prodTakeUp(productId) {
    $.ajax({
        type : "get",
        url : "/second_hand_market/data/search/takeUpOrDownProd",
        dataType : "json",
        data : {
            productId : productId,
            isSelling : "1"
