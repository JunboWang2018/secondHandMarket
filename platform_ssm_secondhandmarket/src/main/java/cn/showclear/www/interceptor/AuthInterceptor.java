...
import cn.com.scooper.auth.service.IAuthService;
import cn.com.scooper.auth.vo.VerifyVo;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (enableAuth) {
            ...
            try {
                ...
                if (!authService.verifyIdentity(verify)) {
                    return failNotLogin(request, response);
                }

                // 设置到 request 中，便于后期获取
                request.setAttribute(CommonConstant.TOKEN_REQUEST_KEY, token);
